const translations = {
  ...
  fr: {
    ...
    aboutParagraph1: `<br>Je m'appelle Tiana Breeze et je suis une artiste biélorusse-polonaise, née en 1982 à Vitebsk, en Biélorussie. Ma mère est biélorusse et mon père est polonais. Nous allions souvent en Pologne rendre visite aux proches de mon père. En 2017, ma famille et moi avons déménagé en Pologne pour y vivre définitivement, où je vis et crée encore aujourd'hui.<br></br>Je dessine depuis mon enfance et je suis devenue célèbre dans mon pays en tant que caricaturiste. Dès l'âge de 13 ans, mes dessins ont été publiés dans des magazines et des journaux, tels que « Vecherniy Vitebsk », Vitebsk Worker, Vitbichi, Picnic, Vozhyk, Shapoklyak et d'autres.`,
    aboutParagraph2: `J'ai organisé cinq expositions individuelles. Je suis lauréate d'un concours régional de dessins animés. J'adore la satire et la caricature, mais ma vraie passion est devenue la peinture à l'huile.<br><br></br>J'ai obtenu mon diplôme à la Faculté des Beaux-Arts et des Arts Graphiques de l'Université d'État de Vitebsk. J'ai réalisé mon travail de diplôme dans l'atelier de peinture à l'huile sous la direction du professeur Anatoly Chmil et je l'ai soutenu avec mention. J'ai trouvé que la peinture à l'huile était la meilleure technique pour exprimer ma passion créative.<br>Pour des raisons rationnelles, j'ai changé d'avis et suis devenue manager après deux ans à l'Université Technologique d'État de Vitebsk, diplômée en gestion-économie. Bien que ma carrière se développait bien, j'ai réalisé plus tard que ce n'était pas ce que je voulais vraiment. Déménager en Pologne, la patrie de mon père, m'a permis de continuer à peindre. Maintenant, je suis artiste professionnelle à plein temps et je suis heureuse de pouvoir faire ce que j'aime.<br><br>Je suis membre de l'Union des Artistes Polonais, Peintres et Graphistes. Mes œuvres figurent dans des collections privées aux États-Unis, au Royaume-Uni, en Allemagne, en Biélorussie, en Pologne et ailleurs.`,
