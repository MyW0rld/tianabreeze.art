...
I work with a multilayered oil painting technique, which allows me to achieve complex color nuances and depth.
Reflections, optical effects, and the interaction of light with the surface of water become more than just subjects — they are means of expression. They allow me to go beyond literal depiction, creating a space filled with air, movement, and emotion.

I am fascinated by how objects transform in water, dissolve, and take on new forms.
It is a view of the world not directly, but through its reflection — a perspective that makes perception deeper, more intriguing, prompting the viewer to look closer and search for new meanings.

Each of my works is the result of a journey — both external and internal.
In my paintings, I capture not only a moment but also its emotional resonance, allowing the viewer to experience it and feel its uniqueness.
...
Woda nigdy nie jest taka sama — tak jak ludzkie emocje, wspomnienia i doświadczenia.  
To właśnie ta płynność i nietrwałość przyciągają mnie, zmuszając do ciągłego poszukiwania nowych sposobów ukazania jej żywej istoty na płótnie.

Pracuję techniką warstwowego malarstwa olejnego, która pozwala mi uzyskać złożone niuanse kolorystyczne i głębię.  
Refleksy, efekty optyczne i interakcje światła z powierzchnią wody stają się czymś więcej niż tylko tematami — są środkami wyrazu.  
Pozwalają mi wyjść poza dosłowne przedstawienie, tworząc przestrzeń wypełnioną powietrzem, ruchem i emocją.

Fascynuje mnie, jak obiekty zmieniają się w wodzie, rozpuszczają się i przybierają nowe formy.  
To spojrzenie na świat nie bezpośrednio, lecz przez jego odbicie — perspektywa, która pogłębia postrzeganie, intryguje i skłania widza do zatrzymania się i poszukiwania nowych znaczeń.

Każda z moich prac to wynik podróży — zarówno zewnętrznej, jak i wewnętrznej.  
Na moich obrazach utrwalam nie tylko chwilę, ale także jej emocjonalny rezonans, pozwalając widzowi doświadczyć jej i poczuć jej wyjątkowość.

Dla tych, którzy szukają głębi.  
Dla tych, którzy nigdy nie przestają.  
Dla tych, którzy chcą poczuć.`,
